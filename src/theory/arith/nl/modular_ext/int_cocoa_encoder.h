...
#ifndef CVC5__THEORY__INT__COCOA_H
#define CVC5__THEORY__INT__COCOA_H
...
class CocoaEncoder
{
 public:
  ...
  void endScanIntegers(std::vector<long> weights);
...
#endif /* CVC5__THEORY__INT__COCOA_H */
